...
@app.route("/")
def index(): return render_template("pages/home.html")
...
def venues():
    ...
    for city, state in results:
        ...
        data.append({"city": city, "state": state, "venues": venueList})
